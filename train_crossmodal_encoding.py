...
for ninputfilters in [2,8,16]:
    for nfeat in [int(ninputfilters/2),ninputfilters,2*ninputfilters,4*ninputfilters]:
        ...
        for epoch in tqdm(range(nbepoch)):
            train_loss.append(train_kl(epoch,trainloader,net,optimizer,kl_im,kl_audio,kl_places,mseloss=mseloss))
            val_loss.append(test_kl(epoch,valloader,net,optimizer,kl_im,kl_audio,kl_places,mseloss=mseloss))
        ...
        test_loss = test_kl(1,testloader,net,optimizer,kl_im,kl_audio,kl_places,mseloss=mseloss)
